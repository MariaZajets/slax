defmodule SlaxWeb.ChatRoomLive do
  ...
  def mount(_params, _session, socket) do
    rooms =
      Chat.list_joined_rooms_with_unread_counts(socket.assigns.current_user)
  ...
  def handle_params(params, _uri, socket) do
    ...
    |> push_event("reset-pagination", %{can_load_more: !is_nil(page.metadata.after)})
      ...
      cond do
        ...
        message.user_id != socket.assigns.current_user.id ->
          update(socket, :rooms, fn rooms ->
            # credo:disable-for-next-line Credo.Checkrefactor.Nesting
            Enum.map(rooms, fn
